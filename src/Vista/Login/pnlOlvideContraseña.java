...
public class pnlOlvideContraseña extends javax.swing.JPanel {
    ...
    private void btnCrearUsuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearUsuActionPerformed
        ...
        if (validar()) {
            ...
            Main.mensaje(300, 30, "CAMBIANDO CONTRASEÑA....", 3, "/Recursos/Imagenes/spinner-of-dots.png");
            if (Main.controUsuario.validarCampoUsuario(txtCedula.getText().trim(), "cedula", "usuario")) {
                if (Main.controUsuario.validarOlvidoContrasena(txtCedula.getText().trim(), cbPreguntaS.getSelectedIndex(), txtRespuesta.getText().trim())) {
                    if (Main.controUsuario.cambiarContrasena(txtContrasena.getText().trim(), txtCedula.getText().trim())) {
                        Main.mensaje(300, 30, "!SE HA CAMBIADO LA CONTRASEÑA EXITOSAMENTE!", 2, "/Recursos/Imagenes/Cuenta.png");
                        abrirIniciarSesion();
                    }
                    System.out.println("...");
                } else {
                    Main.mensaje(300, 30, "Los datos ingresados no coinciden con la cedula", 2, "/Recursos/Imagenes/cancel.png");
                }
            } else {
                Main.mensaje(300, 30, "La cedula ingresada no existe", 2, "/Recursos/Imagenes/cancel.png");
            }
        }
